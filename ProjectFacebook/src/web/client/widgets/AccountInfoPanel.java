...
public class AccountInfoPanel extends Composite {
	...
	private static AccountInfoPanelUiBinder uiBinder = GWT.create(AccountInfoPanelUiBinder.class);//руками не трогать
	
	@UiField Label nameField;//виджеты внутри нашей панели
	@UiField Button privatePage;
